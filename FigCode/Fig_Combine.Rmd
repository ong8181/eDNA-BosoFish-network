...
![
**Figure 1| Study sites and overall dynamics of environmental DNA (eDNA) concentrations and the number of fish species detected.** (**a**) Study sites in the Boso Peninsula. The study sites are influenced by the Kuroshio current (red arrow; left panel) and distributed along the coastal line in the Boso Peninsula (right panel).  (**b**) The total eDNA copy numbers estimated by the quantitative eDNA metabarcoding (see Methods for detail). (**c**) Fish species richness detected by the eDNA metabarcoding. Points and lines indicate raw values and LOESS smoothing lines, respectively. Line color indicates sampling site. Warmer colors generally correspond to study sites with higher mean water temperature.
...
![
**Figure 2| The interaction networks of fish community in the Boso-peninsula coastal region**. (**a**) "Average" interaction network reconstructed by quantifying information transfer between eDNA time series. Transfer entropy (TE) was quantified by leveraging all eDNA time series from multiple study sites to draw this network. Only information flow larger than 80% quantiles were shown as interspecific interactions just for the visualization. Edge color indicates relative interaction strengths, and fish illustration colors represent their ecology (e.g., habitat and feeding behavior). (**b**) Site-specific fish interaction networks. Each site-specific network was reconstructed by multispecies eDNA time series from a single site. Nodes represent fish species as in the averaged network in **a**. For **a** and **b**, node color and node size indicate fish family and fish abundance (total eDNA copy numbers of the fish species). 
...
![
**Figure 3| Dependence of interaction strengths on biotic and abiotic variables**. Panel shows the relationship between fish species interaction strengths (quantified as information flow; transfer entropy [TE]) and (**a**) latitude, (**b**) median annual water temperature of each study site, (**c**) species richness, and (**d**) total eDNA copy numbers. $y$-axis indicates TE as an index of interaction strength between fish species. Line indicates nonlinear regression line estimated by general additive mixed model (GAMM).
...
![
**Figure 4| Temperature dependence of fish species interactions**. (**a**) Temperature effects on fish species interactions quantified as information flow (transfer entropy; TE). Points indicate TE value of each interaction for each species at each site. The interactions includes giving and receiving effects. Red and blue lines indicate statistically clear positive and negative relationships between temperature and interaction strength estimated by generalized linear model (GLM). (**b**) Distributions of temperature effects on interactions (i.e., slopes of regression between interaction strength and water temperature estimated by GLM). Red, pink, and gray colors indicate statistically clear ($P$ < 0.05; $P$ < 0.10) and unclear (not statistically clear; N.S.) slopes between interaction strengths and water temperature, respectively. 
